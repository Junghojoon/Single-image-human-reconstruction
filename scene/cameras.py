...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, fx, fy, cx, cy, image, image_name, image_path, uid,  # image_path 추가
        ...
        self.image_path = image_path  # 이 줄 추가
        self.hdr = hdr
    ...
    def get_extrinsics(self):
        ...
        # Rt[:3, 3] = self.T.flatten()  # T를 (3,) 형상으로 변환
        Rt[:3, 3] = self.T
